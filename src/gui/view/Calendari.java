 ...
 * @author Arber
 */
public class Calendari extends javax.swing.JFrame {
...
public class DatePickerSample extends Application {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calendari.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
